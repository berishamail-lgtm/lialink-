...
export async function POST(req: NextRequest) {
    ...
    <div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;color:#0f0e0d">
      ...
      <div style="border:1px solid #ddd9d3;border-top:none;border-radius:0 0 16px 16px;padding:32px">
        ...
        <table style="width:100%;font-size:14px;border-collapse:collapse;margin-bottom:20px">
          ...
          <tr><td style="padding:8px 0;color:#6b6560">LIA-period</td><td style="padding:8px 0;font-weight:bold">${a.lia_start} – ${a.lia_end}</td></tr>
        </table>
  ...
  try {
    await resend.emails.send({
      ...
      to: recipients,
      subject: `LIA-avtal signerat: ${studentName} ↔ ${companyName}`,
      html,
      attachments: [{
